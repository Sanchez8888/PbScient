...
namespace Projet_PSI
{
    internal class BDD
    {
        ...
        public bool AjouterPlat(string nomPlat, int idCuisinier, int nbPersonnes, string typePlat, double prix, string dateFabrication, string dateExpiration, string regime, string origine)
        {
            string connectionString = $"server=localhost;port=3306;user id=root;password=root;database={this.nom};";

            string query = @"INSERT INTO (nom_plat, id_cuisinier, nb_personnes, type_plat, prix, date_fabrication, date_expiration, regime, origine) VALUES (@NomPlat, @IdCuisinier, @NbPersonnes, @TypePlat, @Prix, @DateFabrication, @DateExpiration, @Regime, @Origine);";
...
WHERE id_cuisinier = @IdCuisinier;";
        ...
        public bool ValiderCommande(int idCommande)
        {
            ...
            string query = "UPDATE Commande SET livre = TRUE WHERE id_commande = @IdCommande;";
